    ...
    <div class="profile-page">
        <div class="row">
            ...
            <div class="col-md-9 col-12">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-6" :style="isMobile() ? {marginBottom:'10px'}:{}"
                             v-for="(product ,$index) in products" :key="$index">
                            <oneProductOffer v-bind:addToCart="addToCart"
...
<script>
    ...
    import oneProductOffer from '../views/pages_components/oneProductOffer'
