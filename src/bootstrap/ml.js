...
export default new MLCreate({
    ...
    languages: [
        ...
        new MLanguage('ar').create({
            ...
            page_no: 'عدد الصفحات',
            publisher: 'الناشر',
            published_at: 'سنة النشر',
            status: 'الحالة',
            section: 'القسم',
            share: 'شارك عبر الوسائل التالية',
            kuwait: 'الكويت',
            author: 'الكاتب',
            new_arrival: 'صدر حديثا',
            best_sales: 'الاكثر مبيعا',
            book: 'كتاب',
            favourite: 'المفضلة',
            ...
            change: 'تغيير',
            address: 'العنوان',
            shipping_data: 'اذا تعدت قيمة الطلب مبلغ ',
            shipping_data2: 'تفرض  عليك رسوم شحن بقيمة ',
            ...
            subscribe_p: 'اشترك معنا ليصلك كل جديد',
            offers: 'العروض',
            ...
            dar_sama: 'دار سما للنشر والتوزيع',
            message: 'نص الرسالة',
            send: 'ارسال  ',
            male: 'ذكر',
            female: 'انثي  ',
            ...
            sale_complete: ' سيتم التواصل معاك علي الهاتف بخصوص الاوردر',
            ...
            site_search: 'عنوان الكتاب / اسم المؤلف',
